...
package com.dudog4cloud.dudog.common.core.config;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	/**
	 * 增加GET请求参数中时间类型转换 {@link com.dudog4cloud.dudog.common.core.jackson.PigJavaTimeModule}
	 * <ul>
